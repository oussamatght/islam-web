...
const optionsContainer = document.getElementById("options") as HTMLElement;
...
function showQuestion(): void {
  ...
  current.answers.forEach((answer: Answer) => {
...
function selectAnswer(e: Event): void {
  ...
  const correct: boolean = selected.dataset.correct === "true";
